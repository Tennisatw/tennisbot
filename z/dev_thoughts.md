...
draft_patch实在是要求太严了。我考虑自己写一个简单的规则：文件名：替换前，替换后。没了。

draft_patch处理引号时可能有bug。

Tennisbot修改代码时可以直接用我的规则。

话说Tennisbot的编程能力毋庸置疑。我觉得真可以放开让她彻底自己写代码了。

<br>

什么事情都可以商量决定。不要忘了整个项目都是“自举”出来的。商量本身也可以商量。